...
public class GroupDetailController {
    ...
    @FXML private TableView<GroupMember> memberTable;
    @FXML private TableColumn<GroupMember, String> avatarColumn;
    @FXML private TableColumn<GroupMember, String> studentCodeColumn;
    @FXML private TableColumn<GroupMember, String> studentNameColumn;
    @FXML private TableColumn<GroupMember, String> roleColumn;
    @FXML private TableColumn<GroupMember, String> statusColumn;
    @FXML private TableColumn<GroupMember, Integer> abandonCountColumn;
    @FXML private TableColumn<GroupMember, Void> actionColumn;
    ...
    private void setupTableColumns() {
        ...
        avatarColumn.setCellFactory(col -> new TableCell<>() {
            ...
            {
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource(com.aptech.projectmgmt.util.SceneManager.AVATAR_CELL));
    ...
    private TableCell<GroupMember, Void> createActionCell() {
        return new TableCell<>() {
            ...
            {
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource(com.aptech.projectmgmt.util.SceneManager.SINGLE_ACTION_CELL));
    ...
    private void handleExclude(GroupMember member) {
        ...
        if (!AlertUtil.showConfirm("Xac nhan huy quyen tham gia cua " + member.getStudentFullName() + "?")) return;
        ...
        if (currentStaff == null) { AlertUtil.showError("Khong xac dinh duoc staff"); return; }
    ...
    private Optional<String> showReasonDialog(String studentName) {
        try {
            ...
            controller.initData(
                    "Ly do huy quyen tham gia",
                    "Nhap ly do huy quyen cua " + studentName,
                    ""
            );
