...
public class TaskService {
	...
	public void reassignTask(int taskId, int assignedStudentId, LocalDateTime estimatedStartDate,
		...
		taskRepository.reassignTask(taskId, assignedStudentId, estimatedStartDate, estimatedEndDate,
				changedByStudentId);
	}

	public List<TaskViewModel> getTasksByStudentInGroup(int groupId, int studentId) {
		return taskRepository.getTasksByStudentInGroup(groupId, studentId);
	}

	public void assignTask(int taskId, int assignedStudentId, int changedByStudentId) {
		taskRepository.assignTask(taskId, assignedStudentId, changedByStudentId);
	}
	...
	public void startTask(int taskId, int studentId) {
		...
		taskRepository.insertStatusHistory(taskId, TaskStatus.PENDING.getValue(), TaskStatus.IN_PROGRESS.getValue(),
				getCurrentAccountId(), now);
	}
	...
	public void submitForReview(int taskId, int studentId) {
		...
		taskRepository.insertStatusHistory(taskId, TaskStatus.IN_PROGRESS.getValue(), TaskStatus.REVIEWING.getValue(),
				getCurrentAccountId(), now);
	}
	...
	public void requestRevision(int taskId, int studentId, String note) {
		...
		taskRepository.insertStatusHistory(taskId, TaskStatus.REVIEWING.getValue(), TaskStatus.REVISING.getValue(),
				getCurrentAccountId(), now);
	...
	public void confirmCompleted(int taskId, int studentId) {
		...
		taskRepository.insertStatusHistory(taskId, TaskStatus.REVIEWING.getValue(), TaskStatus.COMPLETED.getValue(),
				getCurrentAccountId(), now);
	}
	...
	public void submitRevised(int taskId, int studentId) {
		...
		LocalDateTime now = LocalDateTime.now();
		taskRepository.updateStatus(taskId, TaskStatus.REVIEWING.getValue());
		taskRepository.insertStatusHistory(taskId, TaskStatus.REVISING.getValue(), TaskStatus.REVIEWING.getValue(),
				getCurrentAccountId(), now);
	}
	...
	public void createTask(Task task) {
		...
		taskRepository.insertStatusHistory(taskId, TaskStatus.PENDING.getValue(), TaskStatus.PENDING.getValue(),
				getCurrentAccountId(), LocalDateTime.now());
	}
